...
public class RegistrationIntentService extends IntentService
{
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        SharedPreferences RegistrationIntentPreferences = this.getSharedPreferences("NotificationsHubSettings", 0);
        ...
        try
        {
            ...
            if ((regID = RegistrationIntentPreferences.getString("registrationID", null)) == null)
            {
                ...
                RegistrationIntentPreferences.edit().putString("registrationID", regID).apply();
            }
            else
            {
        ...
        /*if (Home.isVisible)
        {
            Home.mainActivity.ToastNotify(resultString);
        }*/
    }
}
